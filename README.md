...
```bash
# Go module
go get github.com/wau/wau-registry

# 或 clone + 手动 build
git clone https://github.com/XploreAlpha/wau-registry.git
cd wau-registry
go build ./...
```
...
# 2. 跑 self-test(若有 cmd/wau-registry/selftest)
go run ./cmd/wau-registry selftest
